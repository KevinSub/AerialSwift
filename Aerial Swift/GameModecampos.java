...
public class GameModecampos extends JFrame implements KeyListener
{
    ...
    public GameModecampos ()
    {
	super ("GameModecampos");     // Set the frame's name
	...
	lblPic2 = new ImageIcon (getClass ().getResource ("rsz_campos.png"));
    ...
    {
	new GameModecampos (); // Call constructor to create a a frame
    }



} // GameModecampos class
