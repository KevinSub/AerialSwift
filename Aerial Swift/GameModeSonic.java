...
public class GameModeSonic extends JFrame implements KeyListener
{
    ...
    public GameModeSonic ()
    {
	super ("GameModeSonic");     // Set the frame's name
	...
	lblPic2 = new ImageIcon (getClass ().getResource ("sonicFly.gif"));
    ...
    {
	new GameModeSonic (); // Call constructor to create a a frame
    }
