...
public class GameModeBird extends JFrame implements KeyListener
{
    ...
    public GameModeBird ()
    {
	super ("GameModeBird");     // Set the frame's name
	...
	lblPic2 = new ImageIcon (getClass ().getResource ("birdFly.gif"));
    ...
    {
	new GameModeBird (); // Call constructor to create a a frame
    }
