...
public class GameModeSpyro extends JFrame implements KeyListener
{
    ...
    public GameModeSpyro ()
    {
	super ("GameModeSpyro");     // Set the frame's name
	...
	lblPic2 = new ImageIcon (getClass ().getResource ("spyroFly.gif"));
    ...
    {
	new GameModeSpyro (); // Call constructor to create a a frame
    }
